...
async function initializeBrowserFheInstance() {
    ...
    // https://sepolia.infura.io/v3/d68962a4a63e470c99e1dab4bd5e133c
    // https://ethereum-sepolia-rpc.publicnode.com
    const config = { ...SepoliaConfig, network: 'https://ethereum-sepolia-rpc.publicnode.com' };
    console.log('🔧 FHEVM browser instance config:', config);
    try {
        fheInstance = await createInstance(config);
        console.log('✅ FHEVM browser instance created');
        return fheInstance;
    }
    catch (err) {
